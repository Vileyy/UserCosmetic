      ...
      <View style={styles.card}>
        ...
        <View style={styles.inputContainer}>
          <TextInput
            ...
            onChangeText={(text) => setConfirmPassword(removeVietnameseTones(text))}
          />
        ...
        <View style={styles.passwordChecklist}>
          ...
          <PasswordRequirement text="Bắt đầu bằng chữ in hoa" isValid={isUpperCaseValid} />
          <PasswordRequirement text="Có ít nhất một ký tự đặc biệt (@, #, $...)" isValid={isSpecialCharValid} />
          <PasswordRequirement text="Có ít nhất một số" isValid={isNumberValid} />
        </View>

        {/* Nút Xác nhận */}
        <TouchableOpacity
          style={[styles.button, { backgroundColor: isPasswordValid ? "#F08080" : "#aaa" }]}
...
// Component kiểm tra mật khẩu
const PasswordRequirement = ({ text, isValid }) => (
  <View style={styles.requirement}>
    <Ionicons name={isValid ? "checkmark-circle" : "close-circle"} size={20} color={isValid ? "green" : "red"} />
    <Text style={{ marginLeft: 5, color: isValid ? "green" : "red" }}>{text}</Text>
  </View>
);
